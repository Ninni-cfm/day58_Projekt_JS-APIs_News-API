...
sources         A comma-seperated string of identifiers for the news sources or blogs you want
                headlines from.
                Use the /top-headlines/sources endpoint to locate these programmatically or look
                at the sources index. Note: you can't mix this param with the country or category
                params.

q               Keywords or a phrase to search for.

pageSize        The number of results to return per page (request).
int             20 is the default, 100 is the maximum.

page            Use this to page through the results if the total results found is greater than
int             the page size.
*/
